...
function maintenace_mode() {
      ...
      if ( !current_user_can( 'edit_themes' ) || !is_user_logged_in() ) {die('.');}
...
function attorney_posted_on() {
	printf( __( '<div class="att-meta">Data <a href="%1$s" title="%2$s" rel="bookmark" class="att-meta-link"><time class="entry-date" datetime="%3$s">%4$s</time></a></div><div class="att-meta">Escrito por <a class="url fn n att-meta-link" href="%5$s" title="%6$s" rel="author">%7$s</a></div>', 'attorney' ),
...
if ( ! function_exists( 'attorney_posted_onoff' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author de páginas com iamgem.
 */
function attorney_posted_onoff() {
	printf( __( '<div class="att-meta">Data <a href="%1$s" title="%2$s" rel="bookmark" class="att-meta-link"><time class="entry-date" datetime="%3$s">%4$s</time></a></div>', 'attorney' ),
		esc_url( get_permalink() ),
		esc_attr( get_the_time() ),
		esc_attr( get_the_date( 'c' ) ),
		esc_html( get_the_date() )
