...
function attorney_posted_on() {
	...
	printf( __( '<div class="att-meta">Publicado em <a href="%1$s" title="%2$s" rel="bookmark" class="att-meta-link"><time class="entry-date" datetime="%3$s">%4$s</time></a></div><div class="att-meta">Escrito por <a class="url fn n att-meta-link" href="%5$s" title="%6$s" rel="author">%7$s</a></div>', 'attorney' ),
		...
		esc_attr( sprintf( __( 'Veja todos os posta de %s', 'attorney' ), get_the_author() ) ),
